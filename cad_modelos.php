	...
	<div id="container">
		<main>
			...
			<form action="cad_modelos.php" method="post">
				<p><label for="icodmod">Número:</label></p>
				<p><input type="number" id="icodmod" name="codmod"></p>

				<p><label for="idesc_2">Descrição:</label></p>
				<p><input type="text" id="idesc_2" name="desc_2"></p>
